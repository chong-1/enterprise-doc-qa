...
class KnowledgeBaseUpdate(BaseModel):
    ...
    chunk_size: int | None = Field(default=None, ge=128, le=2048, description="分块大小")
    chunk_overlap: int | None = Field(default=None, ge=0, le=512, description="分块重叠")
...
class KnowledgeBaseResponse(BaseModel):
    ...
    my_role: str = "viewer"  # 当前用户在此知识库的角色
    created_at: datetime
    updated_at: datetime
